let imgCount = 0
const data = [
  {img: 'images/persona1.jpeg', name: 'Julieta', edad: '20', distancia: '2'},
  {img: 'images/persona2.jpeg', name: 'Juan', edad: '23', distancia: '5'},
  {img: 'images/persona3.jpeg', name: 'Erika', edad: '25', distancia:'7'},
  {img: 'images/persona1.jpeg', name: 'Julieta', edad: '20', distancia: '2'},
  {img: 'images/persona2.jpeg', name: 'Juan', edad: '23', distancia: '5'},
  {img: 'images/persona3.jpeg', name: 'Erika', edad: '25', distancia:'7'}
]
...
function appendCard(data) {
  ...
  newCard.innerHTML = `
          ...
          <div class="bottom">
            <div class="title">
              <span>${data.name}</span>
              <span>${data.edad}</span> <b>años</b>     </div>
            <div class="info">
              ${data.distancia} kms de distancia
            </div>
          </div>
        `
